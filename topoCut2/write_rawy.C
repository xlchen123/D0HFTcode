...
void write_rawy()
{
    ...
    THnF* hnmassUL = (THnF*)fin->Get("hD0CentPtEtaMDphiDaug_150efficiency");
    //hnmassUL->SetDirectory(0);
    THnF* hnmassLS = (THnF*)fin->Get("hD0CentPtEtaMDphiDaugLikeSign_150efficiency");
    //hnmassLS->SetDirectory(0);
    THnF* hnmassMixUL = (THnF*)fin->Get("hD0CentPtEtaMDphiDaugMixed_150efficiency");
    //hnmassMixUL->SetDirectory(0);
    THnF* hnmassMixLS = (THnF*)fin->Get("hD0CentPtEtaMDphiDaugLikeSignMixed_150efficiency");
    ...
    for(int icent=0; icent<ncent; icent++) {
        ...
        for(int ipt=0; ipt<npt; ipt++) {
            ...
            int dau1NPtBin = nDugts+1;  //11 //6
            int dau2NPtBin = nDugts+1;  //11 //6
            ...
            float norm = hInvMassMixLS->Integral(mbin_lw,mbin_up) ? hInvMassLS->Integral(mbin_lw,mbin_up) / hInvMassMixLS->Integral(mbin_lw,mbin_up) : 0;
