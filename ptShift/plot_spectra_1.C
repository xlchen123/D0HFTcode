...
void plot_spectra_1() {
    ...
    const int ncent = 4;
    const char nameCent[ncent][250] = {"0-20%", "20-40%", "40-60%", "60-80%"};
    //const char nameCent1[ncent][250] = {"0-10%", "10-20% [#times20]", "20-40% [#times5]", "40-60%  [/2]", "60-80%  [/2]"};
    const char nameCent1[ncent][250] = {"0-20%", "20-40% [/3]", "40-60% [/6]", "60-80% [/12]"};
    const char nameCentXL[ncent][250] = {"0_20", "20_40", "40_60", "60_80"};
    //const char nameCentGN[ncent][250] = {"4", "2", "1", "0"};
    
    const float scale[ncent] = {1., 1/3., 1/6., 1/12.};
    ...
    const float legy_lw = 0.93 - 0.05*ncent;
    legend1 = new TLegend(0.68,legy_lw,0.9,0.93);
