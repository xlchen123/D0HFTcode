...
void plot_rawy_bg()
{
    ...
    for(int icent=0; icent<ncent; icent++) {
        ...
        for(int ipt=0; ipt<npt; ipt++) {
            ...
            fD0->SetParameters(N, 1.866, 0.014, 0.01, 0.5*N, -0.5*N);
            ...
            int N_y = round(fD0->GetParameter(0));
            int N_error = round(fD0->GetParError(0));
            int Nwr = N_y - N_y%10;
            int Nerrwr = N_error - N_error%10;
            drawLatex(0.55,0.9,Form("RawYield = %i #pm %i",Nwr, Nerrwr),22,0.05,4);
            //drawLatex(0.55,0.9,Form("RawYield = 810 #pm 130"),22,0.06,4);
